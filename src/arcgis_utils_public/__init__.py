...
- Open-gis code (no ArcGIS dependency):
	...
	- Example import: "from arcgis_utils_public import main"
...
- ArcGIS-dependent code (requires ArcGIS Pro/ArcPy):
	...
	- Import as subpackage: "from arcgis_utils_public import arcgis_utils"
...
WHY THIS STRUCTURE:
===================
1. Open-gis code in root allows "import arcgis_utils_public" to work everywhere
...
2. ArcGIS-dependent function/module:
	...
	- Users import directly: "from arcgis_utils_public.arcgis_utils.new_module import new_function"
"""
